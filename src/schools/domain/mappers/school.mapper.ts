...
export class SchoolMapper {
  ...
  toDto(
    ...
    return {
      ...
      lifecycleStatus: (school as any).lifecycleStatus || (school.isActive ? 'ACTIVE' : 'DEACTIVATED'),
      deactivationReason: (school as any).deactivationReason ?? null,
      deactivatesAt: (school as any).deactivatesAt ?? null,
      deactivatedAt: (school as any).deactivatedAt ?? null,
