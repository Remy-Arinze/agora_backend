...
export class NerdcSubjectDto {
  ...
  @ApiPropertyOptional({ example: 'CORE', description: 'Subject category (CORE, ELECTIVE, VOCATIONAL)' })
...
export class NerdcCurriculumWeekDto {
  ...
  @ApiProperty({ example: ['Understand place value up to millions'], description: 'Learning objectives' })
  objectives: string[];

  @ApiProperty({ example: ['Group work', 'Number puzzles'], description: 'Suggested activities' })
  activities: string[];

  @ApiProperty({ example: ['Textbook Chapter 1', 'Number cards'], description: 'Required resources' })
  resources: string[];
