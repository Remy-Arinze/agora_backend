...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      ...
      outline:
        'border-2 border-gray-300 dark:border-dark-border bg-transparent text-gray-700 dark:text-dark-text-primary hover:bg-gray-50 dark:hover:bg-dark-surface focus:ring-gray-500',
